"""case1000 (case5~8) 일괄 E2E 검증 스크립트.

단일 파일 시나리오 (~1000자). 기대값 파일 포함.

실행:
  python scripts/case1000_e2e_test.py           # 전체
  python scripts/case1000_e2e_test.py --case 0   # case5만
"""
import asyncio
import os
import sys
...
CASE_DIR = os.path.join(
    ...
    "data", "sample", "case1000"
)

TEST_CASES = [
    {"name": "case5", "file": "case5.txt", "expectation": "expectation5.txt"},
    {"name": "case6", "file": "case6.txt", "expectation": "expectation6.txt"},
    {"name": "case7", "file": "case7.txt", "expectation": "expectation7.txt"},
    {"name": "case8", "file": "case8.txt", "expectation": "expectation8.txt"},
]
...
async def main_all():
    print("=" * 70)
    print("  case1000 (case5~8) 일괄 E2E 검증")
    print("=" * 70)
