...
| 27 | **Phase 0 구현 완료** | FastAPI 기본 뼈대, Pydantic 모델, React 프론트엔드 스캐폴딩 완료 |
...
1. **Phase 1 실행** — 문서 파싱 (`IngestService`) 및 추출 프롬프트 (`extract_entities.py`) 구현
2. **Phase 1 실행** — 추출 서비스 (`ExtractionService`) 클래스 구현 마무리
